...
-- Execute this in Supabase SQL Editor to fix all infinite recursion issues
...
-- Fix team_members_access policy
...
-- Fix team_members_manage policy
...
-- Fix team_members_update policy
...
-- Fix team_members_delete policy
...
-- Fix installations_access policy
...
-- Fix installations_create policy
...
-- Fix installations_update policy
...
-- Fix installations_delete policy
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'RLS INFINITE RECURSION FIXES COMPLETED';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'All 26+ RLS policies have been updated to use JWT claims';
    RAISE NOTICE 'instead of recursive SELECT statements from users table.';
    RAISE NOTICE 'This eliminates infinite recursion and improves performance.';
    RAISE NOTICE '========================================';
END $$;