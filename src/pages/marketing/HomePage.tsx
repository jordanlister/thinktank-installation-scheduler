...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="pt-16 lg:pt-20">
      ...
      />
      {/* Hero Section */}
      <Section spacing="2xl" className="relative overflow-hidden min-h-[90vh] flex items-center py-20">
        {/* Animated Background */}
        ...
        <Container className="relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            {/* Main Headline */}
            <Heading variant="h1" className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Transform Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-success-light block mt-2">
                Field Service
              </span>
              Operations
            </Heading>
            ...
            {/* Subheading */}
            <Text size="xl" className="text-text-secondary mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 text-sm text-text-muted">
      ...
      <Section spacing="2xl" className="bg-surface/50">
        <Container>
          ...
          <Grid cols={{ base: 1, md: 2, lg: 3 }} gap={8}>
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-brand-primary font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                40% reduction in travel time <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-success font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                35% fuel cost savings <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-brand-accent font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                25% increase in capacity <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-warning font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                90% faster reporting <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-info font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                Zero manual mapping <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 bg-surface-glass backdrop-blur-xl border border-border rounded-xl hover:border-brand-primary/30 hover:bg-surface-glass/80 transition-all duration-300 group">
              ...
              <div className="text-sm text-brand-primary font-medium group-hover:translate-x-1 transition-transform inline-flex items-center">
                50+ integrations <ArrowRight className="w-4 h-4 ml-1" />
              </div>
            </div>
          </Grid>
        </Container>
      ...
      <Section spacing="2xl">
        <Container>
          ...
          <Grid cols={{ base: 1, sm: 2, lg: 4 }} gap={8} className="mb-16">
            <div className="text-center p-6 rounded-xl bg-surface-glass/50 backdrop-blur-sm border border-border/50">
            ...
            <div className="text-center p-6 rounded-xl bg-surface-glass/50 backdrop-blur-sm border border-border/50">
              <div className="text-3xl md:text-4xl font-bold text-brand-primary mb-2">2M+</div>
            ...
            <div className="text-center p-6 rounded-xl bg-surface-glass/50 backdrop-blur-sm border border-border/50">
              <div className="text-3xl md:text-4xl font-bold text-brand-primary mb-2">99.9%</div>
      ...
      <Section spacing="2xl" className="relative overflow-hidden">
        ...
        <Container className="text-center relative z-10">
          <Heading variant="h2" className="text-4xl md:text-5xl font-bold text-white mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-sm text-text-muted">
            <span className="flex items-center">
              <CheckCircle className="w-4 h-4 mr-2 text-success" />
              Free 14-day trial
            </span>
